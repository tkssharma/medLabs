angular.module('mapGeolocation.services', []).factory('MapGeolocationService', MapGeolocationService);

    MapGeolocationService.$inject = ['$q'];
    /**
     * @name MapGeolocationService
     * @desc Service for user geolocation
     */
    function MapGeolocationService($q) {
